...
external_genomes_504_set_outgroup_v3 <- read.delim("external_genomes_504_set_outgroup_v3.txt", stringsAsFactors = FALSE)
...
cd ~/path/to/working/directory/phylogenies/SAR11_165_504_outgroup
...
final_SAR11_268 <- read.delim("final_SAR11_269_name.txt", stringsAsFactors = FALSE)
...
write.csv(external_genomes_268_set, file = "external_genomes_268_set.csv")
...
iqtree -s concatenated_genes_268_v1/concatenated-best_alphaproteobacteria165_out-clean.fa -m LG+F+R10 -T AUTO -ntmax 10 --alrt 1000 -B 1000 --mem 60G
...
set_268 <- read.delim("genomes_268_set.txt", stringsAsFactors = FALSE)
...
# write the file
write_delim(LAYERS_SAR11_268_v1, file="LAYERS_SAR11_268_v1.txt")
...
mkdir concatenated_genes_268_v2_avedetection
# put relevant files in there

cd ~/concatenated_genes_268_v2_avedetection
...
LAYERS_SAR11_268_v5 <- read.delim("LAYERS_SAR11_268_v5.txt", header = TRUE,  sep = "\t")

LAYERS_SAR11_268_v6 <- LAYERS_SAR11_268_v5 %>% 
  left_join(y=LAYERS_SAR11_481_v16_ecogenomics_GTDB, by=c("accession" = "accession"))

write.csv(LAYERS_SAR11_268_v6, file="LAYERS/LAYERS_SAR11_268_v6.csv")
...
external_paths <- read.delim("external_genomes_504_set_outgroup_v3.txt", header = TRUE,  sep = "\t") 
