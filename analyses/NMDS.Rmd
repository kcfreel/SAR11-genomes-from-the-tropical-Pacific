...
coverage.in <- read.csv(file = here("~/path/to/working/directory/Q2Q3.csv"))
detection.in <- read.csv(file = here("~/path/to/working/directory/DETECTION.csv"))
sar11.info.in <- read.table(file = here("~/path/to/working/directory/SAR11-INFO.txt"), header = T)
...
#This actually save the plot in a image
    ggsave(file="~/path/to/working/directory/nmds_v1.svg", plot=image, width=10, height=8)
...
ggsave("~/path/to/working/directory/images/nmds_v1.svg")

ggsave("~/path/to/working/directory/images/nmds_v1.svg", width = 50, height = 30, units = "cm")

ggsave("~/path/to/working/directory/images/nmds_v2.svg", width = 50, height = 50, units = "cm")
...
ggsave("~/path/to/working/directory/images/nmds_v3.svg", width = 50, height = 30, units = "cm")
...
saveWidget(widget = ggplotly_to_save,
           file = "~/path/to/working/directory/images/nmds_v3.html")
